...
func InitData() {
	...
	menus := []model.Menu{
		...
		},
		{
			...
			Redirect:  "/system/personnel/user",
			Sort:      5,
			ParentId:  uint1,
			Roles:     roles[:1],
			Creator:   "系统",
		},
		{
			...
			Icon:      peopleStr,
			Path:      "user",
			Component: "/system/personnel/user/index",
			Sort:      6,
			ParentId:  uint2,
			Roles:     roles[:1],
			Creator:   "系统",
		},
		{
			...
			Icon:      groupStr,
			Path:      "group",
			Component: "/system/personnel/group/index",
			Sort:      7,
			ParentId:  uint2,
			NoCache:   1,
			Roles:     roles[:1],
		...
		},
		{
			...
			Icon:      roleStr,
			Path:      "role",
			Component: "/system/service/role/index",
			Sort:      10,
			ParentId:  uint4,
			Roles:     roles[:1],
			Creator:   "系统",
		},
		{
			...
			Icon:      treeTableStr,
			Path:      "menu",
			Component: "/system/service/menu/index",
			Sort:      13,
			ParentId:  uint4,
			Roles:     roles[:1],
			Creator:   "系统",
		},
		{
			...
			Icon:      treeStr,
			Path:      "api",
			Component: "/system/service/api/index",
			Sort:      14,
			ParentId:  uint4,
			Roles:     roles[:1],
			Creator:   "系统",
		...
		},
		{
			...
			Path:      "operation-log",
			Component: "/system/log/operation-log/index",
			Sort:      21,
			ParentId:  uint8,
			Roles:     roles[:2],
			Creator:   "系统",
