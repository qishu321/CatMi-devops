...
// Add 添加数据
func (l RoleSvc) Add(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	...
	if system.Role.Exist(tools.H{"name": r.Name}) {
...
// List 数据列表
func (l RoleSvc) List(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
...
// Update 更新数据
func (l RoleSvc) Update(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	...
	// 不能更新比自己角色等级高或相等的角色
	// 根据path中的角色ID获取该角色信息
	roles, _ := system.Role.GetRolesByIds([]uint{r.ID})
	if len(roles) == 0 {
	...
	err = system.Role.Find(filter, oldData)
	if err != nil {
	...
	system.User.ClearUserInfoCache()

	return nil, nil
}

// Delete 删除数据
func (l RoleSvc) Delete(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	...
	// 删除角色
	err = system.Role.Delete(r.RoleIds)
	if err != nil {
...
func (l RoleSvc) GetMenuList(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	...
	menus, err := system.Role.GetRoleMenusById(r.RoleID)
	if err != nil {
...
// GetApiList 获取角色接口列表
func (l RoleSvc) GetApiList(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	...
	role := new(model.Role)
	err := system.Role.Find(tools.H{"id": r.RoleID}, role)
	if err != nil {
		return nil, tools.NewMySqlError(fmt.Errorf("获取资源失败: " + err.Error()))
	}

	policies, _ := common.CasbinEnforcer.GetFilteredPolicy(0, role.Keyword)
...
// UpdateMenus 更新角色菜单
func (l RoleSvc) UpdateMenus(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	...
	// 获取当前用户所拥有的权限菜单
	ctxUserMenus, err := system.Menu.GetUserMenusByUserId(ctxUser.ID)
	if err != nil {
	...
	err = system.Role.UpdateRoleMenus(roles[0])
	if err != nil {
